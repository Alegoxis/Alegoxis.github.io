...
//https://json.extendsclass.com/bin/ea589bbd5287
//../datas/db.json
async function fetchDb() {
  await fetch("https://api.jsonbin.io/v3/b/693ec531ae596e708f996ab6", {
    headers: {
      "X-Access-Key":
        "$2a$10$hUPLDyzJ7NTX71YAkDB7POGgWm4PA36FX2dHKQ3JwtWGUdkjU6RBy",
    },
  })
    .then((res) => res.json())
    .then((json) => (globalDb = json.record));
...
async function learn(question, answer) {
  ...
  const res = await fetch(
    `https://api.jsonbin.io/v3/b/693ec531ae596e708f996ab6`,
    {
      method: "PATCH",
      headers: {
